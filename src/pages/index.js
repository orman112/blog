    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <p className="alert">
          ...
          understand a subject. So, I created this <Link to="/blog">blog</Link>{" "}
          to do just that! I hope you enjoy reading some of my content as I take
          this journey to expand my knowledge on certain topics, while also
          rambling about a few other areas that interest me as well. I also hope
          you find them useful and learn something along the way!
        </p>
